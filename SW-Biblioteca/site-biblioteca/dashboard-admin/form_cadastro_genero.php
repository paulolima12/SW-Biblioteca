...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4" style="font-weight: 600;">Gerenciamento de gêneros</h1>
            ...
            <button class='btn btn-outline-light' style="margin-bottom: 1rem; background-color: #ee0979"
                data-bs-toggle="modal" data-bs-target="#bookModal">Cadastrar gênero</button>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT genero.id_genero, genero.genero FROM genero";
                            $consulta = $conexao->query($sql);
                            while ($dados = $consulta->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . $dados['id_genero'] . "</td>";
                                echo "<td>" . $dados['genero'] . "</td>";
                                echo "<td>
                                        <a href='apaga_genero.php?id_genero=" . $dados["id_genero"] . "'>
                                            <button  
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bookModalLabel">Adicionar gênero</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="bookForm" method="POST" action="adiciona_campos.php">
                        <div class="mb-3">
                            <label style="margin-bottom: 0" for="genero" class="form-label">Tipo de gênero de livro</label>
                            <p style="font-size: smaller; color: #666666">Não se esqueça de verificar se o gênero já está cadastrado.</p>
                            <input type="text" class="form-control" id="genero" name="genero"  maxlength="150" minlength="4" placeholder="ex.: Machado de Assis." required>
                        </div>
