...
if ($acao == 'aceitar_devolucao' && $dados['status_devolucao'] === 'pendente') {
    ...
    $sql = "UPDATE emprestimo SET status_devolucao = 'atrasada', `status` = 'atrasado' WHERE id_emprestimo = $id_emprestimo;
...
} else if ($acao == 'aceitar_devolucao_atrasada' && $dados['status_devolucao'] === 'pendente') {
    $sql = "UPDATE emprestimo SET status_devolucao = 'confirmada', `status` = 'concluído' WHERE id_emprestimo = $id_emprestimo;
